...
describe("lib/rounding", () => {
  ...
  describe("roundCoordinate6", () => {
    it("should round to 6 decimal places", () => {
      expect(roundCoordinate6(9.005456789)).toBe(9.005457);
      expect(roundCoordinate6(38.763643219)).toBe(38.763643);
    });

    it("should provide higher precision", () => {
      const coord4 = roundCoordinate(9.005456789);
      const coord6 = roundCoordinate6(9.005456789);
  ...
  describe("round (type-based)", () => {
    ...
    it("should apply coordinate6 rounding", () => {
      expect(round(9.005456789, "coordinate6")).toBe(9.005457);
    });
  });
});
