...
import { getNotificationRoute as resolveNotificationRoute } from "@/lib/notificationRoutes";
...
export default function NotificationBell() {
  ...
  // Item 18 (G18-1..G18-4): single source of truth in lib/notificationRoutes.ts.
  // Keep this thin local wrapper so the JSX call site stays unchanged.
  const getNotificationRoute = (
    notification: Notification,
    role: string
  ): string | null =>
    resolveNotificationRoute(notification.type, role, notification.metadata);

  // legacy local switch removed — single source: lib/notificationRoutes.ts
