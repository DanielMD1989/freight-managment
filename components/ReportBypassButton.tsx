            ...
            <div className="relative w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
              <div className="mb-4">
                ...
                <p className="mt-2 text-sm text-[#064d51]/70">
                  If you believe this shipper is attempting to bypass the
                  platform by asking for direct contact after viewing contact
                  information, please report it here.
                </p>
              </div>
              ...
              <div className="mb-4">
                <label
                  htmlFor="reason"
                  className="mb-2 block text-sm font-medium text-[#064d51]/80"
                >
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full rounded-lg border border-[#064d51]/20 px-3 py-2 focus:border-red-500 focus:ring-2 focus:ring-red-500"
              ...
              <div className="flex items-center justify-end gap-3">
                <button
                  ...
                  disabled={loading}
                  className="rounded-lg border border-[#064d51]/20 bg-white px-4 py-2 text-sm font-medium text-[#064d51]/80 hover:bg-[#f0fdfa] disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
