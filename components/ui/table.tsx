...
export function TableHeader({ className = '', children, ...props }: TableHeaderProps) {
  return (
    <thead className={`bg-gray-50 dark:bg-slate-700 ${className}`} {...props}>
      {children}
    </thead>
  );
}
...
export function TableFooter({ className = '', children, ...props }: TableFooterProps) {
  return (
    <tfoot
      className={`bg-gray-100 font-medium dark:bg-slate-800 ${className}`}
      {...props}
    >
      {children}
    </tfoot>
...
export function TableRow({ className = '', children, ...props }: TableRowProps) {
  return (
    <tr
      className={`transition-colors hover:bg-gray-50 dark:hover:bg-slate-700/50 ${className}`}
      {...props}
    >
      {children}
    </tr>
