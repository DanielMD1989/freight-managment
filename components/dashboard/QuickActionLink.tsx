...
const colorStyles = {
  ...
  secondary:
    "bg-secondary-500/10 hover:bg-secondary-500/20 text-secondary-600 dark:text-secondary-400",
  success:
    "bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400",
  accent:
    "bg-accent-500/10 hover:bg-accent-500/20 text-accent-600 dark:text-accent-400",
};
...
export default function QuickActionLink({
  ...
  return (
    <Link
      href={href}
      className={`block rounded-lg px-4 py-3 transition-colors ${colorStyles[color]}`}
    >
