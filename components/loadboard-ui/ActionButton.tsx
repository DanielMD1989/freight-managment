...
export default function ActionButton({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={` ${variantStyles[variant]} ${sizeStyles[size]} inline-flex transform items-center justify-center rounded-xl font-semibold transition-all duration-200 ease-out hover:-translate-y-0.5 focus:ring-2 focus:ring-teal-500/50 focus:ring-offset-2 focus:outline-none active:translate-y-0 disabled:transform-none disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none ${className} `}
    >
