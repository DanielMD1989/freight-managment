    ...
    <div className="mt-2">
      ...
      <div className="flex justify-between text-xs">
        ...
        <div className="flex gap-2 text-gray-500 dark:text-gray-400">
          <span className={checks.length ? 'text-green-600' : ''}>8+ chars</span>
...
export default function SecuritySettingsClient({
  ...
  const [activeTab, setActiveTab] = useState<'password' | 'sessions' | 'activity'>('password');
  ...
  // MFA state
  const [mfaStep, setMfaStep] = useState<'idle' | 'phone' | 'verify' | 'codes'>('idle');
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full px-4 py-2 text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors"
              >
          ...
          <div className="pt-6 border-t border-gray-200 dark:border-slate-700">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full max-w-md px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-gray-900 dark:text-white"
                  />
                  <button
                    onClick={handleDisableMFA}
                    disabled={isDisablingMFA || !disablePassword}
                    className="px-4 py-2 text-sm font-medium text-red-600 border border-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 disabled:opacity-50 rounded-lg transition-colors"
                  >
              ...
              <div className="space-y-4 max-w-md">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <p className="text-sm text-blue-800 dark:text-blue-300">
                    Step 1: Enter your phone number to receive verification codes
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 rounded-lg transition-colors"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <div className="space-y-4 max-w-md">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="000000"
                    maxLength={6}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-gray-900 dark:text-white text-center text-2xl tracking-widest font-mono"
                  />
                </div>
                <div className="flex gap-2">
                  <button
            ...
            {mfaStep === 'codes' && recoveryCodes.length > 0 && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2 p-4 bg-gray-100 dark:bg-slate-800 rounded-lg font-mono text-sm">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 hover:bg-gray-50 dark:text-gray-300 dark:border-slate-600 dark:hover:bg-slate-800 rounded-lg transition-colors"
                >
                  Copy All Codes
                </button>
                <button
                  ...
                  className="ml-2 px-4 py-2 text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 rounded-lg transition-colors"
                >
                  Done
                </button>
              </div>
          ...
          <div className="flex items-center justify-between">
            ...
            {sessions.length > 1 && (
              <button
                ...
                className="px-3 py-1.5 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors disabled:opacity-50"
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {index === 0 && (
                          <span className="px-2 py-0.5 text-xs font-medium text-teal-700 bg-teal-100 dark:text-teal-400 dark:bg-teal-900/50 rounded">
                            Current
                          </span>
                        )}
                      </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {event.deviceInfo || 'Unknown device'} · {event.ipAddress || 'Unknown IP'}
                      </p>
                    </div>
                  </div>
