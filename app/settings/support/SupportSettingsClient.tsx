...
export default function SupportSettingsClient({ userId, userRole }: SupportSettingsClientProps) {
  ...
  const handleSubmitReport = async () => {
    ...
    try {
      ...
      setReportForm({ type: 'FRAUD', description: '', entityType: '', entityId: '' });
    } catch (error) {
  ...
  return (
    <div className="p-6">
      ...
      {/* Contact Support */}
      <div className="mb-8 p-6 bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {helpTopics.map((topic) => (
            <a
              key={topic.title}
              href={topic.link}
              className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-slate-800 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors"
            >
      ...
      <div className="border border-gray-200 dark:border-slate-700 rounded-lg overflow-hidden">
        <div className="px-4 py-3 bg-gray-50 dark:bg-slate-800">
          ...
          <div className="p-4 space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setReportForm({ ...reportForm, entityType: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setReportForm({ ...reportForm, entityId: e.target.value })}
