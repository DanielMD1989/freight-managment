/**
 * Load Requests Client Component (Carrier View)
 *
 * Sprint 18 - Story 18.1: Carrier views outgoing load requests
 *
 * Shows the carrier's outgoing load requests with status filtering
 * and navigation to approved loads/trips
 */
...
export default function LoadRequestsClient({ requests }: Props) {
