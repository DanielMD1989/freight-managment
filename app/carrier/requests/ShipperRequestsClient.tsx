...
export default function ShipperRequestsClient({
        ...
        <div className="space-y-4">
          {filteredRequests.map((request) => (
            ...
            >
                  ...
                  <div className="flex gap-2">
                    {showResponseForm === request.id ? (
                      <button
                        ...
                        className="rounded-lg border border-[#064d51]/15 px-3 py-1 text-sm text-[#064d51]/70 hover:bg-[#f0fdfa]"
                      >
                        Cancel
                      </button>
                    ) : (
              ...
              {/* Response Form */}
              {showResponseForm === request.id && (
                <div className="mb-4 rounded-lg bg-[#f0fdfa] p-4 dark:bg-slate-700">
                  <label className="mb-2 block text-sm font-medium text-[#064d51]/80 dark:text-gray-300">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-lg border border-[#064d51]/20 px-3 py-2 focus:ring-2 focus:ring-[#1e9c99] dark:border-slate-600 dark:bg-slate-600 dark:text-white"
                  />
                  ...
                  <div className="flex flex-wrap gap-4 text-sm">
                    {request.offeredRate && (
                      <div className="rounded-lg bg-yellow-50 px-3 py-2 dark:bg-yellow-900/20">
                        <span className="font-medium text-yellow-800 dark:text-yellow-200">
                          Offered Rate: {request.offeredRate.toLocaleString()}{" "}
                          ETB
                        </span>
                      </div>
                    )}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-2 text-xs text-emerald-600 dark:text-emerald-400">
                        {request.load.shipper?.name || "Shipper"} •{" "}
                        {request.load.shipper?.phone ||
                          request.requestedBy?.phone ||
                          request.requestedBy?.email ||
