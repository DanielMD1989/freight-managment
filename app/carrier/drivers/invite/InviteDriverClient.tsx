      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl bg-white p-8 shadow-sm dark:bg-slate-800">
          <div className="mb-6 text-center">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 dark:bg-emerald-900">
              <svg
          ...
          <div className="mb-6 rounded-xl border border-indigo-100 bg-indigo-50 p-6 text-center dark:border-indigo-800 dark:bg-indigo-950">
            <p className="mb-1 text-xs font-semibold tracking-wider text-indigo-500 uppercase dark:text-indigo-400">
              Invite Code
            </p>
            <p className="font-mono text-4xl font-bold tracking-widest text-indigo-700 dark:text-indigo-300">
              {result.inviteCode}
            </p>
            <button
              onClick={copyCode}
