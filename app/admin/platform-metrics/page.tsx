          ...
          <div className="grid grid-cols-1 gap-4 text-sm text-blue-800 md:grid-cols-2">
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>User Metrics:</strong> Total users, active rates, and
              ...
              <li className="flex items-start gap-2">
                <span className="font-bold">•</span>
                <span>
                  <strong>Load Performance:</strong> Completion rates, active
                  loads, and status distribution
                </span>
              </li>
            </ul>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="font-bold">•</span>
                <span>
                  <strong>Financial Health:</strong> Total revenue, settlement
                  status, and service fee tracking
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="font-bold">•</span>
                <span>
                  <strong>Trust & Safety:</strong> Flagged organizations,
                  disputes, and bypass detection
                </span>
              </li>
            </ul>
          </div>
