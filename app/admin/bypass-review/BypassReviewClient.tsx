  ...
  const fetchFlaggedOrganizations = async () => {
    try {
      ...
      const response = await fetch(
        `/api/admin/bypass-warnings/organizations?status=${status}`
      );
  ...
  if (loading) {
    return (
      <div className="rounded-lg bg-white p-12 text-center shadow">
        ...
        <p className="mt-4 text-gray-600">Loading flagged organizations...</p>
      </div>
    );
  }
            ...
            <div>
              ...
              <p className="mt-1 text-3xl font-bold text-orange-600">
                {organizations.reduce(
                  (sum, o) => sum + o.bypassAttemptCount,
                  0
                )}
              </p>
            </div>
                  ...
                  <div className="ml-4 flex gap-2">
                    ...
                    {org.isFlagged && (
                      <button
                        ...
                        className="rounded bg-gray-100 px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200"
                      >
                        Unflag
                      </button>
                    )}
