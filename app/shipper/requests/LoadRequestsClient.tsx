                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {(request.carrier.phone || request.requestedBy?.phone) && (
                          <>
                            <a
                      ...
                      <p className="text-xs text-emerald-600 dark:text-emerald-400 mt-2">
                        {request.carrier.name} • {request.carrier.phone || request.requestedBy?.phone || request.requestedBy?.email || 'Contact via platform'}
                      </p>
                    </div>
                  </div>
                </div>
