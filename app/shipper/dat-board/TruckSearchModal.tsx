          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 border-b border-gray-200 pb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Full/Partial</label>
                  <select
            ...
            {/* Deadhead Distances */}
            <div className="md:col-span-2 border-b border-gray-200 pb-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Deadhead Distances (km)</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">DH-Origin Min</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">DH-Origin Max</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">DH-Dest Min</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">DH-Dest Max</label>
                  <input
                    type="number"
