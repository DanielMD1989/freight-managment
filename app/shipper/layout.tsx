 ...
 *
 * Main layout for shipper portal with navigation
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 min-h-[calc(100vh-4rem)] sticky top-16">
          <nav className="p-4 space-y-1">
            <NavLink href="/shipper" icon="📊">
              Dashboard
            </NavLink>
            <NavLink href="/shipper/loads" icon="📦">
              My Loads
            </NavLink>
            <NavLink href="/shipper/loads/create" icon="➕">
              Post New Load
            </NavLink>
            <NavLink href="/shipper/matches" icon="🚛">
              Truck Matches
            </NavLink>
            <NavLink href="/shipper/documents" icon="📄">
              Documents
            </NavLink>
            <NavLink href="/shipper/wallet" icon="💰">
              Wallet
            </NavLink>
            <NavLink href="/shipper/transactions" icon="💳">
              Transactions
            </NavLink>
            <NavLink href="/shipper/settings" icon="⚙️">
              Settings
            </NavLink>
          ...
          {!organization && (
            <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-yellow-800">
                ...
                organization to access shipper features.{' '}
                <Link
