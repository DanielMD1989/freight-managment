...
const user = await prisma.user.findUnique({
  where: { email: "shipper@test.com" }, select: { organizationId: true },
});
...
console.log("Navigating to (shipper)/wallet...");
await page.goto("http://localhost:8088/(shipper)/wallet", { waitUntil: "domcontentloaded" });
await page.waitForTimeout(7000);
