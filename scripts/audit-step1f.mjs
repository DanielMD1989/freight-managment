// Step 1a — read /shipper/loads?status=delivered for shipper@test.com
...
await page.goto("http://localhost:3000/shipper/loads?status=delivered", {
...
console.log(JSON.stringify({
  url: "/shipper/loads?status=delivered",
  dbCount,
  webRaw: found.raw,
