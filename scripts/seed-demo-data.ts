 ...
 *
 * Mirrors `seedWalletWithJournal` in seed-test-data.ts. After this function
 * returns, the wallet's stored balance equals `initialBalance` AND there is
 * exactly one matching DEPOSIT journal entry. Re-seeding wipes prior journal
 * lines for this wallet so the ledger stays in sync.
 */
async function seedWalletWithJournal(
  ...
  if (wallet) {
    // Wipe prior journal lines + orphaned entries for this wallet
...
async function main() {
  ...
  const shipperOrgsData = [
    ...
    {
      name: "Merkato Trading PLC",
      type: "SHIPPER" as const,
      city: "Addis Ababa",
      email: "merkato@demo.com",
      phone: "+251911100002",
    },
    {
      name: "Dire Industries",
      type: "SHIPPER" as const,
      city: "Dire Dawa",
      email: "dire@demo.com",
      phone: "+251911100003",
    ...
    {
      name: "Mekelle Textiles",
      type: "SHIPPER" as const,
      city: "Mekelle",
      email: "mekelle@demo.com",
      phone: "+251911100004",
    },
    {
      name: "Hawassa Foods",
  ...
  const shipperUsersData = [
    {
      email: "agri-shipper@demo.com",
      firstName: "Abebe",
      lastName: "Kebede",
      phone: "+251911100011",
      orgName: "Ethio Agri Export",
    },
    {
      email: "merkato-shipper@demo.com",
      firstName: "Tigist",
      lastName: "Hailu",
      phone: "+251911100012",
      orgName: "Merkato Trading PLC",
    },
    {
      email: "dire-shipper@demo.com",
      firstName: "Mohammed",
      lastName: "Ahmed",
      phone: "+251911100013",
      orgName: "Dire Industries",
    },
    {
      email: "mekelle-shipper@demo.com",
      firstName: "Berhane",
      lastName: "Gebre",
      phone: "+251911100014",
      orgName: "Mekelle Textiles",
    },
    {
      email: "hawassa-shipper@demo.com",
      firstName: "Sara",
      lastName: "Tadesse",
      phone: "+251911100015",
      orgName: "Hawassa Foods",
    },
  ];
  ...
  const carrierUsersData = [
    {
      ...
      lastName: "Yohannes",
      phone: "+251922200011",
      orgName: "Selam Transport",
      isAdmin: true,
    },
    {
      email: "selam-driver@demo.com",
      firstName: "Getachew",
      lastName: "Mekonnen",
      phone: "+251922200012",
      orgName: "Selam Transport",
    ...
    {
      email: "abay-admin@demo.com",
      firstName: "Kalkidan",
      lastName: "Desta",
      phone: "+251922200013",
      orgName: "Abay Logistics",
      isAdmin: true,
    },
    {
      email: "abay-driver@demo.com",
      firstName: "Yonas",
      lastName: "Belay",
      phone: "+251922200014",
      orgName: "Abay Logistics",
    ...
    {
      email: "eastern-admin@demo.com",
      firstName: "Fatuma",
      lastName: "Ali",
      phone: "+251922200015",
      orgName: "Eastern Cargo",
      isAdmin: true,
    },
    {
      email: "eastern-driver@demo.com",
      firstName: "Hussien",
      lastName: "Osman",
      phone: "+251922200016",
      orgName: "Eastern Cargo",
    ...
    {
      email: "northern-admin@demo.com",
      firstName: "Tsegaye",
      lastName: "Abraha",
      phone: "+251922200017",
      orgName: "Northern Express",
      isAdmin: true,
    },
    {
      email: "northern-driver@demo.com",
      firstName: "Gebru",
      lastName: "Haile",
      phone: "+251922200018",
      orgName: "Northern Express",
    ...
    {
      email: "riftvalley-admin@demo.com",
      firstName: "Alemayehu",
      lastName: "Negash",
      phone: "+251922200019",
      orgName: "Rift Valley Haulers",
      isAdmin: true,
    },
    {
      email: "riftvalley-driver@demo.com",
      firstName: "Bekele",
      lastName: "Worku",
      phone: "+251922200020",
      orgName: "Rift Valley Haulers",
  ...
  for (const userData of carrierUsersData) {
    ...
    if (!user) {
      ...
      counts.usersCreated++;
      console.log(
        `   [+] Created user: ${userData.email} (CARRIER${userData.isAdmin ? " admin" : " driver"})`
      );
    } else {
      await prisma.user.update({
        where: { id: user.id },
  ...
  if (!adminUser) {
    ...
    console.log(
      "       Truck approvals will use first demo carrier admin instead.\n"
    );
  }
  ...
  for (const c of corridorsData) {
    ...
    if (!existing) {
      ...
      console.log(
        `   [+] Created corridor: ${c.name} (${c.distanceKm}km, shipper: ${c.shipperRate}, carrier: ${c.carrierRate} ETB/km)`
      );
    } else {
  ...
  for (const t of trucksData) {
    ...
    console.log(
      `   [+] Created truck: ${t.plate} (${t.type}, ${t.capacity / 1000}T, ${t.city})`
    );
  }
  ...
  const getShipperOrgId = (name: string) =>
    shipperOrgs.find((o) => o.name === name)!.id;
  const getCarrierOrgId = (name: string) =>
    carrierOrgs.find((o) => o.name === name)!.id;
  ...
  const postedLoadsData = [
    {
      shipper: "Ethio Agri Export",
      pickup: "Addis Ababa",
      delivery: "Djibouti",
      type: "DRY_VAN" as const,
      weight: 14000,
      desc: "DEMO: Coffee beans for export - Grade 1 Yirgacheffe",
      pickupDays: 3,
      deliveryDays: 6,
    },
    {
      ...
      type: "FLATBED" as const,
      weight: 18000,
      desc: "DEMO: Agricultural machinery and equipment",
      pickupDays: 2,
      deliveryDays: 4,
    },
    {
      shipper: "Merkato Trading PLC",
      pickup: "Addis Ababa",
      delivery: "Mekelle",
      type: "DRY_VAN" as const,
      weight: 12000,
      desc: "DEMO: Consumer electronics and household goods",
      pickupDays: 4,
      deliveryDays: 7,
    },
    {
      ...
      type: "REFRIGERATED" as const,
      weight: 8000,
      desc: "DEMO: Frozen food products for retail chains",
      pickupDays: 1,
      deliveryDays: 2,
    },
    {
      shipper: "Dire Industries",
      pickup: "Dire Dawa",
      delivery: "Djibouti",
      type: "CONTAINER" as const,
      weight: 22000,
      desc: "DEMO: Containerized industrial equipment for export",
      pickupDays: 5,
      deliveryDays: 7,
    },
    {
      ...
      type: "FLATBED" as const,
      weight: 16000,
      desc: "DEMO: Steel construction materials",
      pickupDays: 3,
      deliveryDays: 5,
    },
    {
      shipper: "Mekelle Textiles",
      pickup: "Mekelle",
      delivery: "Addis Ababa",
      type: "DRY_VAN" as const,
      weight: 10000,
      desc: "DEMO: Textile goods and garments for domestic market",
      pickupDays: 2,
      deliveryDays: 5,
    },
    {
      shipper: "Hawassa Foods",
      pickup: "Hawassa",
      delivery: "Addis Ababa",
      type: "REFRIGERATED" as const,
      weight: 6000,
      desc: "DEMO: Fresh produce and dairy from SNNPR region",
      pickupDays: 1,
      deliveryDays: 2,
    },
  ];
  ...
  for (const ld of postedLoadsData) {
    const load = await prisma.load.create({
      data: {
        ...
        shipperContactName: "Demo Shipper",
        shipperContactPhone: "+251911000001",
        status: "POSTED",
        postedAt: new Date(),
        bookMode: "REQUEST",
        fullPartial: "FULL",
    ...
    counts.loadsCreated++;
    console.log(
      `   [+] POSTED: ${ld.pickup} -> ${ld.delivery} (${ld.type}, ${ld.weight / 1000}T) [${ld.shipper}]`
    );
  }
  ...
  const assignedLoadsData = [
    {
      shipper: "Ethio Agri Export",
      carrier: "Selam Transport",
      truck: "DEMO-ST-DV1",
      pickup: "Addis Ababa",
      delivery: "Djibouti",
      type: "DRY_VAN" as const,
      weight: 15000,
      desc: "DEMO: Sesame seeds export shipment",
      tripStatus: "PICKUP_PENDING" as const,
      pickupDays: 1,
      deliveryDays: 4,
    },
    {
      shipper: "Merkato Trading PLC",
      carrier: "Eastern Cargo",
      truck: "DEMO-EC-DV1",
      pickup: "Addis Ababa",
      delivery: "Dire Dawa",
      type: "DRY_VAN" as const,
      weight: 14000,
      desc: "DEMO: Retail merchandise for Dire Dawa stores",
    ...
    {
      shipper: "Dire Industries",
      carrier: "Abay Logistics",
      truck: "DEMO-AL-FB1",
      pickup: "Dire Dawa",
      delivery: "Addis Ababa",
      type: "FLATBED" as const,
      weight: 18000,
      desc: "DEMO: Industrial raw materials shipment",
      tripStatus: "IN_TRANSIT" as const,
      pickupDays: -2,
      deliveryDays: 1,
    },
    {
      ...
      type: "DRY_VAN" as const,
      weight: 12000,
      desc: "DEMO: Finished textile products for Merkato market",
      tripStatus: "DELIVERED" as const,
      pickupDays: -5,
      deliveryDays: -1,
    },
  ];
  ...
  for (const ld of assignedLoadsData) {
    ...
    const tripData: any = {
      ...
      trackingEnabled: true,
      estimatedDistanceKm:
        ld.pickup === "Addis Ababa" && ld.delivery === "Djibouti" ? 910 : 453,
    };

    // Set timestamps based on trip status
    if (
      ld.tripStatus === "PICKUP_PENDING" ||
      ld.tripStatus === "IN_TRANSIT" ||
      ld.tripStatus === "DELIVERED"
    ) {
    ...
    counts.tripsCreated++;
    console.log(
      `   [+] ASSIGNED: ${ld.pickup} -> ${ld.delivery} (${ld.truck}, trip: ${ld.tripStatus})`
    );
  }
  ...
  const completedLoadsData = [
    {
      ...
      type: "DRY_VAN" as const,
      weight: 18000,
      desc: "DEMO: Coffee export lot AA-2024-001",
      daysAgoCompleted: 3,
    },
    {
      shipper: "Ethio Agri Export",
      ...
      type: "CONTAINER" as const,
      weight: 28000,
      desc: "DEMO: Containerized flower export shipment",
      daysAgoCompleted: 7,
    },
    {
      shipper: "Merkato Trading PLC",
      ...
      type: "DRY_VAN" as const,
      weight: 11000,
      desc: "DEMO: Consumer goods for Eastern markets",
      daysAgoCompleted: 5,
    },
    {
      shipper: "Merkato Trading PLC",
      ...
      type: "REFRIGERATED" as const,
      weight: 9000,
      desc: "DEMO: Refrigerated pharmaceutical products",
      daysAgoCompleted: 10,
    },
    {
      shipper: "Dire Industries",
      ...
      type: "FLATBED" as const,
      weight: 19000,
      desc: "DEMO: Heavy machinery for port delivery",
      daysAgoCompleted: 14,
    },
    {
      shipper: "Mekelle Textiles",
      ...
      type: "FLATBED" as const,
      weight: 16000,
      desc: "DEMO: Textile raw materials and fabrics",
      daysAgoCompleted: 18,
    },
    {
      shipper: "Hawassa Foods",
      carrier: "Rift Valley Haulers",
      truck: "DEMO-RV-DV1",
      pickup: "Hawassa",
      delivery: "Addis Ababa",
      type: "DRY_VAN" as const,
      weight: 10000,
      desc: "DEMO: Processed food products",
      daysAgoCompleted: 22,
    },
    {
      shipper: "Hawassa Foods",
      ...
      type: "DRY_VAN" as const,
      weight: 14000,
      desc: "DEMO: Packaging materials for food industry",
      daysAgoCompleted: 25,
    },
  ];
  ...
  for (const ld of completedLoadsData) {
    ...
    counts.tripsCreated++;
    console.log(
      `   [+] COMPLETED: ${ld.pickup} -> ${ld.delivery} (${ld.truck}, ${ld.daysAgoCompleted}d ago)`
    );
  }
  ...
  for (let i = 0; i < shipperOrgs.length; i++) {
    ...
    await seedWalletWithJournal(
      ...
      "SHIPPER_WALLET",
      shipperBalances[i],
      `Demo shipper initial funding (${org.name})`
    );
    counts.walletsCreated++;
    console.log(
      `   [+] Shipper wallet seeded: ${org.name} (${shipperBalances[i].toLocaleString()} ETB)`
    );
  }
  ...
  for (let i = 0; i < carrierOrgs.length; i++) {
    ...
    await seedWalletWithJournal(
      ...
      "CARRIER_WALLET",
      carrierBalances[i],
      `Demo carrier initial funding (${org.name})`
    );
    counts.walletsCreated++;
    console.log(
      `   [+] Carrier wallet seeded: ${org.name} (${carrierBalances[i].toLocaleString()} ETB)`
    );
  }
  ...
  const availableTrucks = trucksData.filter(
    (t) => !assignedTruckPlates.includes(t.plate)
  );
  ...
  for (const t of postingTrucks) {
    ...
    if (!originCityId) {
      console.log(
        `   [!] No location found for ${t.city}, skipping ${t.plate}`
      );
      continue;
    }
  ...
  for (const pp of proposalPairs) {
    ...
    console.log(
      `   [+] Proposal: Load #${pp.loadIdx + 1} -> ${pp.truck} (${pp.carrier})`
    );
  }
  ...
  const notificationTypes = [
    {
      ...
      message:
        "A new load has been posted matching your truck availability on the Addis Ababa - Djibouti corridor.",
    },
    {
      type: "MATCH_PROPOSAL",
      title: "Match Proposal Received",
      message:
        "A dispatcher has proposed a match for your truck. Review and approve to accept the assignment.",
    },
    {
      type: "POD_SUBMITTED",
      title: "POD Submitted",
      message:
        "Proof of delivery has been submitted for your shipment. Please review and confirm delivery.",
    },
    {
      type: "SETTLEMENT_COMPLETE",
      title: "Settlement Completed",
      message:
        "Your service fee settlement has been processed. Check your wallet for updated balance.",
    },
    {
      type: "GPS_OFFLINE",
      title: "GPS Signal Lost",
      message:
        "GPS signal lost for truck DEMO-ST-DV1. Last known location: Addis Ababa, 2 hours ago.",
    },
    {
      type: "LOAD_REQUEST",
      title: "Load Expiring Soon",
      message:
        "Your posted load from Dire Dawa to Djibouti will expire in 24 hours. Consider extending.",
    },
    {
      type: "MATCH_PROPOSAL",
      title: "Proposal Expiring",
      message:
        "A match proposal for your truck is expiring in 6 hours. Please respond.",
    },
    {
      type: "POD_SUBMITTED",
      title: "POD Verified",
      message:
        "Proof of delivery for load from Mekelle to Addis Ababa has been verified by the shipper.",
    },
    {
      type: "SETTLEMENT_COMPLETE",
      title: "Wallet Topped Up",
      message:
        "Your shipper wallet has been credited with 50,000 ETB. New balance available.",
    },
    {
      type: "GPS_OFFLINE",
      title: "Truck Back Online",
      message:
        "GPS signal restored for truck DEMO-EC-DV2. Current location: Dire Dawa highway.",
    },
    {
      type: "LOAD_REQUEST",
      title: "Load Assigned",
      message:
        "Your load from Addis Ababa to Djibouti has been assigned to Selam Transport.",
    },
    {
      type: "MATCH_PROPOSAL",
      title: "Proposal Accepted",
      message:
        "Carrier has accepted your match proposal. Trip is now being tracked.",
    },
    {
      type: "POD_SUBMITTED",
      title: "Delivery Confirmation Needed",
      message:
        "The carrier has marked delivery as complete. Please confirm receipt of goods.",
    },
    {
      type: "SETTLEMENT_COMPLETE",
      title: "Invoice Generated",
      message:
        "Service fee invoice generated for completed trips this week. Total: 15,450 ETB.",
    },
    {
      type: "GPS_OFFLINE",
      title: "Route Deviation Alert",
      message:
        "Truck DEMO-AL-FB1 has deviated from the expected route. Current heading suggests alternate path.",
    },
    {
      type: "LOAD_REQUEST",
      title: "New Truck Available",
      message:
        "A new refrigerated truck is available in Addis Ababa matching your cargo requirements.",
    },
    {
      type: "MATCH_PROPOSAL",
      title: "Auto-Match Found",
      message:
        "System found an excellent match (92% score) for your posted load. Review the proposal.",
    },
    {
      type: "POD_SUBMITTED",
      title: "Document Upload Required",
      message:
        "Please upload proof of delivery photos for your completed trip to Djibouti.",
    },
    {
      type: "SETTLEMENT_COMPLETE",
      title: "Payment Received",
      message:
        "Settlement payment of 38,500 ETB has been credited to your carrier wallet.",
    },
    {
      type: "GPS_OFFLINE",
      title: "Geofence Entry",
      message:
        "Truck DEMO-ST-DV2 has entered the Djibouti port area. Delivery imminent.",
    },
  ];
  ...
  console.log(
    `   [+] Created ${counts.notificationsCreated} notifications across demo users`
  );
  ...
  for (let i = 0; i < allOrgs.length; i++) {
    const org = allOrgs[i];
    const userId =
      Object.values(userMap).find((u) => u.id)?.id || allDemoUserIds[0];
      ...
      if (!existing) {
        await prisma.companyDocument.create({
          data: {
            ...
            rejectionReason:
              status === "REJECTED"
                ? "Document expired or illegible. Please upload a valid copy."
                : null,
      ...
      if (!existing) {
        await prisma.truckDocument.create({
          data: {
            ...
            rejectionReason:
              status === "REJECTED"
                ? "Document does not match vehicle registration. Please re-upload."
                : null,
  ...
  console.log(
    `  Organizations:   ${counts.orgsCreated} created, ${counts.orgsUpdated} updated`
  );
  console.log(
    `  Users:           ${counts.usersCreated} created, ${counts.usersUpdated} updated`
  );
  console.log(
    `  Corridors:       ${counts.corridorsCreated} created, ${counts.corridorsUpdated} updated`
  );
  console.log(
    `  Locations:       ${counts.locationsCreated} created, ${counts.locationsExisting} existing`
  );
  ...
  console.log(
    `  Wallets:         ${counts.walletsCreated} created, ${counts.walletsUpdated} updated`
  );
  ...
  console.log(
    `  Documents:       ${companyDocsCreated} company, ${truckDocsCreated} truck`
  );
  console.log("");
  ...
  console.log(
    "  COMPLETED: 8 (historical, past 30 days, with journal entries)"
  );
  console.log("");
