// Step 1a — read /shipper/loads?status=expired for shipper@test.com
...
await page.goto("http://localhost:3000/shipper/loads?status=expired", {
...
console.log(JSON.stringify({
  url: "/shipper/loads?status=expired",
  dbCount,
  webRaw: found.raw,
