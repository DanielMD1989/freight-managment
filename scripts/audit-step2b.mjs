...
// Expo Router web strips group parens — try /loads directly
console.log("Navigating to /loads (Expo Router strips group parens)...");
await page.goto("http://localhost:8088/loads", { waitUntil: "domcontentloaded" });
