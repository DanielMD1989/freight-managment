// Step 1a — read /shipper/loads?status=active for shipper@test.com
...
await page.goto("http://localhost:3000/shipper/loads?status=active", {
...
console.log(JSON.stringify({
  url: "/shipper/loads?status=active",
  dbCount,
  webRaw: found.raw,
