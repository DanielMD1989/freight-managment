// Step 1a — read /shipper/loads?status=exception for shipper@test.com
...
await page.goto("http://localhost:3000/shipper/loads?status=exception", {
...
console.log(JSON.stringify({
  url: "/shipper/loads?status=exception",
  dbCount,
  webRaw: found.raw,
