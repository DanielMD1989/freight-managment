// Step 1a — read /shipper/loads?status=in_transit for shipper@test.com
...
await page.goto("http://localhost:3000/shipper/loads?status=in_transit", {
...
console.log(JSON.stringify({
  url: "/shipper/loads?status=in_transit",
  dbCount,
  webRaw: found.raw,
